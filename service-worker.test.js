...
async function main() {
  ...
  ["/index.html", "/duel.html", "/activity-boot.css", "/activity-boot.js", "/styles.css?v=83", "/activity-boot.js?v=83", "/activity-redirect.js?v=83", "/game.js?v=83", "/duel.js?v=83", "/downloads.html", "/downloads.js", "/profile.html", "/privacy.html", "/terms.html", "/legal.css", "/wallpaper.html", "/assets/icon-192.png", "/assets/icon-512.png"].forEach((url) => {
  ...
  assert.match(source, /neon-snake-shell-v83/);
  ...
  const versionedAssetFallback = await dispatchFetch({
    method: "GET",
    mode: "no-cors",
    url: `${origin}/game.js?v=83`,
  });
  assert.equal(versionedAssetFallback.body, "shell:/game.js?v=83");
